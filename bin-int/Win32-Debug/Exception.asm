...
__E578356B_Exception@h DB 01H
__A3D5741C_Exception@cpp DB 01H
...
PUBLIC	?GetLine@Exception@@QBEIXZ			; Exception::GetLine
PUBLIC	?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ; Exception::GetFile
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$?GetLine@Exception@@QBEIXZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$?GetType@Exception@@UBEPBDXZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$?what@Exception@@UBEPBDXZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$??0Exception@@QAE@IPBD@Z DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
_TEXT	SEGMENT
_oss$ = -184						; size = 152
_this$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ PROC ; Exception::GetOriginString, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 25
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __A3D5741C_Exception@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 26
	push	152					; 00000098H
...
; Line 27
	...
	push	ecx
	push	OFFSET ??_C@_07OFNLNJMF@?$FLLine?$FN?5@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 16					; 00000010H
	push	edx
	push	OFFSET ??_C@_07DLGLNFOL@?$FLFile?$FN?5@
...
; Line 30
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN6@GetOriginS
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetOriginString@Exception@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ENDP ; Exception::GetOriginString
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
_TEXT	SEGMENT
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ PROC ; Exception::GetFile, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 21
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 204				; 000000ccH
	push	ebx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetFile@Exception@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ENDP ; Exception::GetFile
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetLine@Exception@@QBEIXZ
_TEXT	SEGMENT
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?GetLine@Exception@@QBEIXZ PROC				; Exception::GetLine, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 17
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetLine@Exception@@QBEIXZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 204				; 000000ccH
	push	ebx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?GetLine@Exception@@QBEIXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetLine@Exception@@QBEIXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetLine@Exception@@QBEIXZ ENDP				; Exception::GetLine
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetType@Exception@@UBEPBDXZ
_TEXT	SEGMENT
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?GetType@Exception@@UBEPBDXZ PROC			; Exception::GetType, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 13
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetType@Exception@@UBEPBDXZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 204				; 000000ccH
	push	ebx
	...
	call	@__CheckForDebuggerJustMyCode@4
; Line 14
	mov	eax, OFFSET ??_C@_0BC@JDPAADN@Regular?5Exception@
; Line 15
	mov	ecx, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?GetType@Exception@@UBEPBDXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetType@Exception@@UBEPBDXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetType@Exception@@UBEPBDXZ ENDP			; Exception::GetType
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?what@Exception@@UBEPBDXZ
_TEXT	SEGMENT
$T2 = -460						; size = 4
$T3 = -448						; size = 28
$T4 = -412						; size = 28
...
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
?what@Exception@@UBEPBDXZ PROC				; Exception::what, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 6
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?what@Exception@@UBEPBDXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?what@Exception@@UBEPBDXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?what@Exception@@UBEPBDXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?what@Exception@@UBEPBDXZ ENDP				; Exception::what
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??0Exception@@QAE@IPBD@Z
_TEXT	SEGMENT
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
_line$ = 8						; size = 4
_file$ = 12						; size = 4
??0Exception@@QAE@IPBD@Z PROC				; Exception::Exception, COMDAT
; _this$ = ecx
; File F:\WindowSandbox\WindowSandbox\src\Exception.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0Exception@@QAE@IPBD@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 204				; 000000ccH
	push	ebx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$??0Exception@@QAE@IPBD@Z:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0Exception@@QAE@IPBD@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0Exception@@QAE@IPBD@Z ENDP				; Exception::Exception
; Function compile flags: /Odtp /RTCsu /ZI
