...
PUBLIC	??_C@_0O@CGGNMOED@Time?5Passed?3?5@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0O@CGGNMOED@Time?5Passed?3?5@
CONST	SEGMENT
??_C@_0O@CGGNMOED@Time?5Passed?3?5@ DB 'Time Passed: ', 00H ; `string'
CONST	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?DoFrame@Game@@AAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?DoFrame@Game@@AAEXXZ$0
	DD	00H
	DD	FLAT:__unwindfunclet$?DoFrame@Game@@AAEXXZ$1
__ehfuncinfo$?DoFrame@Game@@AAEXXZ DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?DoFrame@Game@@AAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
; Line 19
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?DoFrame@Game@@AAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; Line 21
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
; Line 22
	push	OFFSET ??_C@_0O@CGGNMOED@Time?5Passed?3?5@
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?DoFrame@Game@@AAEXXZ$0:
	lea	ecx, DWORD PTR _oss$[ebp]
	jmp	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
__unwindfunclet$?DoFrame@Game@@AAEXXZ$1:
	lea	ecx, DWORD PTR $T2[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	int	3
	int	3
	...
	int	3
	int	3
__ehhandler$?DoFrame@Game@@AAEXXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?DoFrame@Game@@AAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
